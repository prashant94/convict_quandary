from convictquandary import Game, Player, PlayerLogic
from convictquandary.player_logics import LogicAlwaysDefectBelieveTruth, LogicAlwaysCooperateBelieveTruth
...
def test_1v1_game_always_defect_win():
    ...
    game.play_game()
    assert game.get_game_result() == (0, 1000), "Always defect not winning against always cooperate"
